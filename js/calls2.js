...
app.controller('callbackController', function ($scope, $http) {
    ...
    $scope.getcallback = function () {
        ...
        var setcallback = { 'receiptemail': "dsmyth@tempohousing.com", 'name': $scope.form_name, 'company': $scope.form_company, 'number': $scope.form_number, 'email': $scope.form_email, 'comments': $scope.form_comments };
...
function sending_info() {
    ...
    var sending = { 'vname': document.getElementById("name")["value"], 'vemail': 'dsmyth@tempohousing.com', 'vemailreference': document.getElementById("emailref")["value"], 'vphone': document.getElementById("phone")["value"], 'vsubject': document.getElementById("subject")["value"], 'varchitect': document.getElementById("architect")["value"], 'vcontractor': document.getElementById("contractor")["value"], 'vgovernment': document.getElementById("government")["value"], 'vhospitality': document.getElementById("hospitality")["value"], 'vhousing_corporation': document.getElementById("housing_corporation")["value"], 'vproject_development': document.getElementById("project_development")["value"], 'vsupplier': document.getElementById("supplier")["value"], 'vmedia': document.getElementById("media")["value"], 'vother': document.getElementById("other")["value"], 'vnewsletter': document.getElementById("newsletter")["value"], 'vremarks': document.getElementById("remarks")["value"] }
